...
public class ParkingLot2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ParkingLot2 window = new ParkingLot2();
					window.frameML.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frameML = new JFrame();
		frameML.getContentPane().setBackground(new Color(135, 206, 250));
		frameML.setBounds(100, 100, 1104, 688);
		frameML.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frameML.setLocationRelativeTo(null);
		frameML.getContentPane().setLayout(null);
		...
		frameML.getContentPane().add(lblNewLabel);
		
		JTabbedPane tabbedPane = new JTabbedPane(JTabbedPane.TOP);
		tabbedPane.setBounds(10, 84, 1072, 558);
		frameML.getContentPane().add(tabbedPane);
		...
		buttonB1.setBounds(126, 11, 61, 23);
		...
		buttonB2.setBounds(197, 11, 61, 23);
		...
		buttonB3.setBounds(126, 45, 61, 23);
		...
		buttonB4.setBounds(197, 45, 61, 23);
		...
		buttonB5.setBounds(126, 79, 61, 23);
		...
		buttonB6.setBounds(197, 79, 61, 23);
		...
		buttonB7.setBounds(126, 113, 61, 23);
		...
		buttonB8.setBounds(197, 113, 61, 23);
		...
		buttonB9.setBounds(126, 147, 61, 23);
		...
		buttonB10.setBounds(197, 148, 61, 23);
		...
		buttonC1.setBounds(303, 11, 61, 23);
		...
		buttonC2.setBounds(303, 45, 61, 23);
		...
		buttonC3.setBounds(303, 79, 61, 23);
		...
		buttonC4.setBounds(303, 113, 61, 23);
		...
		buttonC5.setBounds(303, 147, 61, 23);
		...
		buttonC6.setBounds(303, 181, 61, 23);
		...
		buttonC7.setBounds(303, 215, 61, 23);
		...
		buttonC8.setBounds(303, 249, 61, 23);
		...
		buttonC9.setBounds(303, 283, 61, 23);
		...
		buttonC10.setBounds(303, 317, 61, 23);
		...
		Parkbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg) {
				if(comboBox_1.getSelectedItem()!="MOTORCYCLE") {
		...
		frameML.getContentPane().add(Logoutbutton);
			}
	}
